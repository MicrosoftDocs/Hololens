...
| Use modern security and authentication methods | https://docs.microsoft.com/en-us/hololens/security-limiting-password-use | Most computer systems today utilize user credentials as the basis for security making them dependent on reusable, user-created passwords. This has resulted in passwords also becoming the most common cause of account compromise and data breaches. |
| Protect against threats during runtime |https://docs.microsoft.com/en-us/hololens/security-hardware-backed-integrity | Hardware-backed integrity and runtime attestation protects against threats that originate prior to the start of an operating system, during runtime, when the device uses hardware, and remote attestation services to ensure integrity is maintained at startup and throughout runtime duration. |
