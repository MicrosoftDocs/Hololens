...
| Access, manage, and share your photos and videos with any device and with any user. | [Find, open, and save files on HoloLens](holographic-data.md#onedrive-app) |
| Ensure security when the device is lost or stolen, and prevent unauthorized applications from accessing sensitive information. | [Encryption and data protection](security-encryption-data-protection.md) |
