...
2. Under **UniversalAppInstall** > **UserContextApp** please enter the **PackageFamilyName**. See [UniversalAppInstall (reference)](https://docs.microsoft.com/en-us/windows/configuration/wcd/wcd-universalappinstall).
...
4. Depending on if you have purchased your app or built your own LOB app, you will need to upload the license file or security certificate. See: [UserContextAppLicense](https://docs.microsoft.com/en-us/windows/configuration/wcd/wcd-universalappinstall#usercontextapplicense).
