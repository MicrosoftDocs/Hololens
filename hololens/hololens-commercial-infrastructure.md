...
For other MDM services, check your provider's documentation for instructions. Refer to the [HoloLens kiosk](hololens-kiosk.md#using-a-mdm-solution-like-intune) instructions if you need to use a custom setting and full XML configuration to set up a kiosk in your MDM service.
