...
| Leave rest of the options as is.                                                                      | ![Leave options](./images/kiosk-steps/kiosk-template-sa-5.png)                                     | Same as single app kiosk |
| Choose which groups / devices or users this configuration profile should get assigned to.             | ![Choose how to assign](./images/kiosk-steps/kiosk-template-sa-6.png)                                     | Same as single app kiosk |
