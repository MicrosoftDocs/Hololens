...
Your devices must be registered in Windows Autopilot before first setup. For MEM documentation on device registration, see [Adding devices to Autopilot](/mem/autopilot/add-devices).  
