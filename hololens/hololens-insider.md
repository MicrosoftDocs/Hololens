...
| [Use only private store apps only for Microsoft Store](#use-only-private-store-apps-only-for-microsoft-store) | Configure the store app to show only apps from organization | IT Admin | 20348.1408 |
