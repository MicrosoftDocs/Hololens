...
| [Using Autopilot with Wi-Fi connection](hololens-insider.md#wi-fi-connection-and-using-autopilot)                  | Use autopilot from device Wi-Fi without need for ethernet adapter.                             | 19041.1364+                 |
